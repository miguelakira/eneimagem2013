...
<ul class="disc">
	<li>
	<p>Promover o encontro de pesquisadores que tenham como tema a Imagem e/ou a discussão da Representação da Imagem no Brasil e exterior, divulgando a produção científica a respeito e proporcionando o intercâmbio entre várias áreas de conhecimento</p>
	</li>
</ul>
<p>
<h1>Realização:</h1>
...
<hr>
<ul class="disc">
    <p> <img src= "/img/logo-uel.gif"> </p>
	<li><p>Laboratório de Estudos dos Domínios da Imagem (LEDI)</p></li>
</ul>
...
<ul class="disc">
	...
	<li>
	<p>Laboratório de Estudos dos Domínios da Imagem (LEDI)</p>
	</li>
	<li>
	<p>Programa de Pós-graduação em História Social</p>
	</li>
	<li>
	<p>Programa de Pós-graduação em Comunicação Visual</p>
	</li>
</ul>
<p>
<h1>Apoio:</h1>
...
<ul class="disc">
	<li>
	<p>Grupo de Pesquisa "Iconografia e Memória"</p>
	</li>
	<li>
	<p>Pró-Reitoria de Extensão</p>
	</li>
	<li>
	<p>Centro de Letras e Ciências Humanas</p>
	</li>
</ul>
